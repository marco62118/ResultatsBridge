                ...
                if (etape.value == EtapeClient.AFFICHAGE_MAINS) {
                    ...
                    if (mainsValides) {
                        ...
                        AffichageMainsScreen(
                            numeroDonne = numDonne,
                            onRetour = {
                                aCliqueAfficherMains.value = false; etape.value =
                                EtapeClient.MOUVEMENT_EN_COURS
                            },
                            onEnregistrer = {
                                mainsSelectionnees.value = it; etape.value =
                                EtapeClient.MOUVEMENT_EN_COURS
                            }
                        )
                    }
                        ...
                        text = {
                            Column(
                                ...
                                mouvementRelais?.donnes?.forEachIndexed { idx, donne ->
                                    ...
                                    OutlinedButton(
                                        onClick = {
                                            indexDonneRelaisEnCours = idx; etape.value =
                                            EtapeClient.SAISIE_MAINS_RELAIS
                                        },
                                        modifier = Modifier.fillMaxWidth().padding(vertical = 3.dp),
                                        colors = ButtonDefaults.outlinedButtonColors(
                                            contentColor = if (mainsDejaLa) Color(
                                                0xFF2E7D32
                                            ) else MaterialTheme.colorScheme.primary
                                        ),
                                        border = BorderStroke(
                                            1.dp,
                                            if (mainsDejaLa) Color(0xFF2E7D32) else MaterialTheme.colorScheme.primary
                                        )
                                    ) {
                                        Text(
                                            if (mainsDejaLa) "👁 Voir mains - Donne ${donne.numero}" else "📤 Saisir mains - Donne ${donne.numero}",
                                            fontWeight = if (mainsDejaLa) FontWeight.Bold else FontWeight.Normal
                                        )
                                    }
                                }
                        ...
                        when (etape.value) {
                            ...
                            EtapeClient.MOUVEMENT_EN_COURS -> {
                                ...
                                MouvementScreen(
                                    ...
                                    onAfficherMains = {
                                        aCliqueAfficherMains.value =
                                            true; visiteMainsEffectuee.value = true; etape.value =
                                        EtapeClient.AFFICHAGE_MAINS
                                    },
                                    onDonneSuivante = { },
