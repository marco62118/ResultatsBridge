...
fun ConstitutionEquipesScreen(
    idTournoi: Int,
    joueursInitiaux: List<embrun.fr.tournoibridgeonline.common.model.Joueur>,
    nombreEquipes: Int,
    ...
    var joueursDispo = remember {
        mutableStateListOf<embrun.fr.tournoibridgeonline.common.model.Joueur>().apply {
            addAll(joueursInitiaux.sortedBy { it.prenom.lowercase() })
        }
    }
    var joueur1         by remember { mutableStateOf<embrun.fr.tournoibridgeonline.common.model.Joueur?>(null) }
    var joueur2         by remember { mutableStateOf<embrun.fr.tournoibridgeonline.common.model.Joueur?>(null) }
...
@Composable
fun JoueurCard(joueur: embrun.fr.tournoibridgeonline.common.model.Joueur, onClick: (() -> Unit)? = null) {
    Card(
        modifier  = Modifier
            .fillMaxWidth()
