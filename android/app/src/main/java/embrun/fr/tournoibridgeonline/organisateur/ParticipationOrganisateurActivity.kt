...
class ParticipationOrganisateurActivity : BaseActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            AppScaffold(ipAddress = ipServeur,
                numeroTournoi = null,
                equipeChoisie = null) {
                Column(modifier = Modifier.Companion.padding(24.dp)) {
                    ...
                    Row {
                        Button(onClick = {
                            Log.i("ParticipationOrganisateurActivity", "🎮 Le Organisateur choisit de jouer")
                        ...
                        Button(onClick = {
                            Log.i("ParticipationOrganisateurActivity", "🧑‍⚖️ Le Organisateur reste organisateur")
                            val resultIntent = Intent().apply {
