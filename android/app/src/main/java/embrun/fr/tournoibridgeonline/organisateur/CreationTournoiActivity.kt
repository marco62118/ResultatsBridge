    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            BridgeServeurTheme {
                ...
                // Chargement des types de tournoi depuis la BD ou le serveur
                LaunchedEffect(Unit) {
                    ...
                    Column(modifier = Modifier.fillMaxWidth()) {
                        ...
                        if (isLoading.value) {
                            ...
                            ExposedDropdownMenuBox(
                                ...
                                OutlinedTextField(
                                    value = selectedOption?.texteAffichage ?: "Aucun type disponible",
                                    onValueChange = {},
                                    readOnly = true,
                                    trailingIcon = {
                                    ...
                                    Column(modifier = Modifier.padding(12.dp)) {
                                        ...
                                        OutlinedTextField(
                                            ...
                                            onValueChange = {
                                                ...
                                                nbreDonnesParTableSaisie = it.filter { c -> c.isDigit() }
                                            },
                                    ...
                                    if (current.tables == 0) {
                                        ...
                                        scope.launch {
                                            ...
                                            val resultat = if (modeOnline) {
                                                ...
                                                val id = if (current.nomBrut == "MitchellGueridon") {
                                            ...
                                            if (resultat.idTournoi > 0) {
                                                Log.i("CreationTournoiActivity", "✅ Tournoi Mitchell créé ID=${resultat.idTournoi}")
                                                val resultIntent = Intent().apply {
                                        ...
                                        scope.launch {
                                            ...
                                            when {
                                                resultat.idTournoi <= 0 && resultat.avertissement != null -> {
                                                    ...
                                                    estBloque = true
                                                    showDialog = true
                                                    Log.w("CreationTournoiActivity", "🚫 Limite dépassée")
                                                }
                                                resultat.idTournoi > 0 && resultat.avertissement != null -> {
                                                    messageAvertissement = resultat.avertissement
                                                    estBloque = false
                                                    resultatEnAttente = Triple(resultat.idTournoi, current.nomBrut, nbEquipes)
                                                    showDialog = true
                                                    Log.i("CreationTournoiActivity", "⚠️ Tournoi créé avec avertissement ID=${resultat.idTournoi}")
                                                }
                                                resultat.idTournoi > 0 -> {
                                                    Log.i("CreationTournoiActivity", "✅ Tournoi Howell créé ID=${resultat.idTournoi}")
                                                    val resultIntent = Intent().apply {
                                                        putExtra("id_tournoi", resultat.idTournoi)
                                                        putExtra("type_tournoi", current.nomBrut)
                                                    ...
                                                    Log.e("CreationTournoiActivity", "❌ Échec création")
                                                    Toast.makeText(
                                                        this@CreationTournoiActivity,
...
fun formaterType(nom: String, tables: Int, donnes: Int): String {
    return "$nom : $tables tables, ${tables * 2} équipes, $donnes donnes"
}
