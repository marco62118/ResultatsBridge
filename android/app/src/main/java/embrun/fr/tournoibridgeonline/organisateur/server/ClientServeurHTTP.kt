package embrun.fr.tournoibridgeonline.organisateur.server
            ...
            uri.startsWith("/getEquipes") -> {
                ...
                if (idTournoi != null) {
                   ...
                   //return newFixedLengthResponse(Response.Status.OK, "application/json", message.toString())
                    Log.i("ClientServeurHTTP", "📤 JSON envoyé : ${message.toString()}")
                    return newFixedLengthResponse(Response.Status.OK, "application/json", message.toString())
...
// ✅ AJOUT : Contrat et Déclarant
                        ...
                        Log.i("ClientServeurHTTP", "   JSON: ${jsonGlobal.toString()}")
